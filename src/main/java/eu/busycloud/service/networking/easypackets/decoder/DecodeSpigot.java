...
public class DecodeSpigot extends EasyPacketListener {

	public DecodeSpigot(EasyPacketHeader receiver) {
		super(receiver);
	}
	...
	public void trigger(SingleServerInstance serverInstance, EasyPacket easyPacket) {
		...
		case "DISABLE":
		{
			CloudInstance.LOGGER.info("SpigotChannel \"" + serverInstance.getId() + "\" disconnected.");
